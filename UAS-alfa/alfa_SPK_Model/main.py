...
class BaseMethod():
    ...
    def data(self):
        ...
        return [{'id': smartphonexiaomi.id, 
        'brand': DEV_SCALE_bran[smartphonexiaomi.brand], 
        'ram': DEV_SCALE_ram[smartphonexiaomi.ram], 
        'prosesor': DEV_SCALE_prosesor[smartphonexiaomi.prosesor], 
        'storage': DEV_SCALE_storage[smartphonexiaomi.storage], 
        'baterai': DEV_SCALE_baterai[smartphonexiaomi.baterai], 
        'ukuran_layar': DEV_SCALE_ukuran_layar[smartphonexiaomi.ukuran_layar], 
        'harga': DEV_SCALE_harga[smartphonexiaomi.harga]} for smartphonexiaomi in session.scalars(query)]
